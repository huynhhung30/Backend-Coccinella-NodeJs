...
var userLogin = function userLogin(email, password) {
  return new Promise( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(resolve, reject) {
      var userInfo, data, checkPassword;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            _context.next = 9;
            return _bcryptjs["default"].compareSync(password, userInfo.password);
          case 9:
...
var userRegister = function userRegister(body) {
  return new Promise( /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(resolve, reject) {
      var userInfo, checkEmailExist, newPassword;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            userInfo = {};
            _context3.next = 4;
            return checkEmailIsExist(body.email);
          case 4:
            checkEmailExist = _context3.sent;
            if (!checkEmailExist) {
              _context3.next = 10;
              break;
            }
            ...
            return _context3.abrupt("return", resolve(userInfo));
          case 10:
          ...
          case 14:
            if (!body.avatar && body.gender === 1) {
              body.avatar = "https://assets.codepen.io/39255/internal/avatars/users/default.png?height=120&width=120";
            }
            if (!body.avatar && body.gender === 0) {
              body.avatar = "https://media.istockphoto.com/id/1390707044/vi/vec-to/b%C3%B2-r%E1%BB%ABng-bizon.jpg?s=612x612&w=is&k=20&c=7jmY3RfSIzV7g3P4v-n_LjvAyP6nK40MGnjOoAEg_Qg=";
            }
            if (!body.backgroundPhoto) {
              body.backgroundPhoto = "https://kynguyenlamdep.com/wp-content/uploads/2021/12/anh-dam-may-scaled.jpg";
            }
          ...
          case 20:
            ...
            return _index["default"].users.create({
              ...
              logging: function logging(msg) {
                return console.log("loggggg hereeeee", msg);
              }
            });
          case 23:
...
var comparePassword = function comparePassword(email) {
  return new Promise( /*#__PURE__*/function () {
...
var checkEmailIsExist = function checkEmailIsExist(email) {
  return new Promise( /*#__PURE__*/function () {
...
// GetAllUsersList
var GetAllUsersList = function GetAllUsersList(id) {
  return new Promise( /*#__PURE__*/function () {
...
var EditUser = function EditUser(body) {
  return new Promise( /*#__PURE__*/function () {
